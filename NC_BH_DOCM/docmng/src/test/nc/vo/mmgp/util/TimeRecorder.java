...
public class TimeRecorder {
    ...
    public void showTime(String sTaskHint) {
        ...
        String sTmp = new String("Time=" + curTime.getTime() + ":->执行<" /* -=notranslate=- */
            + sTaskHint + ">消耗的时间为：" + (lTime / 60000) + "分" /* -=notranslate=- */
            + ((lTime / 1000) % 60) + "秒" + (lTime % 1000) + "毫秒"); /* -=notranslate=- */
