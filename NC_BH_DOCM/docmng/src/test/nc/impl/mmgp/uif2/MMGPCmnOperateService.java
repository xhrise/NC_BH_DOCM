...
public class MMGPCmnOperateService implements IMMGPCmnOperateService {
    ...
    protected void deleteValidate(Object data) throws ValidationException {
        IValidationService validationService =
                ValidationFrameworkUtil.createValidationService(createDeleteValidator());
    ...
    protected void deleteImpl(Object data) throws MetaDataException {
        IMDPersistenceService service = NCLocator.getInstance().lookup(IMDPersistenceService.class);
    ...
    protected void saveValidate(Object data) throws ValidationException {
        IValidationService validationService = ValidationFrameworkUtil.createValidationService(createSaveValidator());
    ...
    protected <T> T saveImpl(T data) throws MetaDataException {
        ...
        NCObject ncobj = queryService.queryBillOfNCObjectByPKWithDR(data.getClass(), pk, true);
    ...
    protected Validator[] createSaveValidator() {
        Validator[] validators = new Validator[]{new BDUniqueRuleValidate(), new DistributedAddBaseValidator() };
        return validators;
    }
    ...
    public <T> T cmnDisableBillData(T data) throws BusinessException {
        try {
            ...
            MMGPVoUtils.setHeadVOFieldValue(
                data,
    ...
    /*
     * (non-Javadoc)
     * @see nc.itf.mmgp.uif2.IMMGPCmnOperateService#cmnEnableBillData(java.lang.Object )
     */
    /**
     * {@inheritDoc}
     */
    ...
    protected void writeInsertBusiLog(Object vo) throws BusinessException {
        ...
        busiLogUtil.writeBusiLog(IBusiOperateConst.ADD, null, convertToSuperVOArray(vo));
    }
    ...
    protected void writeUpdateBusiLog(Object vo) throws BusinessException {
        BDBusiLogUtil busiLogUtil = new BDBusiLogUtil(getBeanID(vo));
        busiLogUtil.writeBusiLog(IBusiOperateConst.EDIT, null, convertToSuperVOArray(vo));
    }
    ...
    protected void writeDeletedBusiLog(Object vo) throws BusinessException {
        BDBusiLogUtil busiLogUtil = new BDBusiLogUtil(getBeanID(vo));
        busiLogUtil.writeBusiLog(IBusiOperateConst.DELETE, null, convertToSuperVOArray(vo));
    }
    ...
    protected void writeEnableBusiLog(Object vo) throws BusinessException {
        BDBusiLogUtil busiLogUtil = new BDBusiLogUtil(getBeanID(vo));
        busiLogUtil.writeBusiLog(IBusiOperateConst.ENABLE, null, convertToSuperVOArray(vo));
    }
    ...
    protected void writeDisableBusiLog(Object vo) throws BusinessException {
        BDBusiLogUtil busiLogUtil = new BDBusiLogUtil(getBeanID(vo));
        busiLogUtil.writeBusiLog(IBusiOperateConst.DISABLE, null, convertToSuperVOArray(vo));
    }
     ...
     *         the business exception
     */
    protected SuperVO[] convertToSuperVOArray(Object obj) throws BusinessException {
        SuperVO[] superVOs;
