...
public class DocViewDataManager implements IAppModelDataManager, IModelDataManager {
	...
	public void initModel() {
		...
		try {
			classVOs = new DocViewAppService().queryByDataVisibilitySetting(getModel().getContext());
		} catch (Exception e) {
