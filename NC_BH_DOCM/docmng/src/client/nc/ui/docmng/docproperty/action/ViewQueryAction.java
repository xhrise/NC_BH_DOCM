...
import nc.ui.docmng.docproperty.treemanage.DocViewModelDataManager;
...
public class ViewQueryAction extends DefaultQueryAction {
	

	private HierachicalDataAppModel treeModel;
	private BillManageModel manageAppModel;
	private DocViewModelDataManager manageModelDataManager;
	...
	public DocViewModelDataManager getManageModelDataManager() {
		return manageModelDataManager;
	}

	public void setManageModelDataManager(
			DocViewModelDataManager manageModelDataManager) {
