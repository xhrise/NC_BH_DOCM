...
public class DocTypeModelDataManager implements IAppModelDataManagerEx,
	...
	public DocTypeModelDataManager(){
		super();
	}
	...
	public void initModelBySqlWhere(String sqlWhere) {
		try {
			 ...
			 */
			String[] pks = (String[]) new DocTypeAppModelService()
			...
			if(this.whereSql==null||this.whereSql.equals("")){
				objs = new DocTypeAppModelService().queryObjectByPks(pks);
			}
			else{
